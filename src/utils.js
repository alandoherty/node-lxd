...
var utils = {
  ...
  class_: function(name, inherit, tbl) {
    ...
    // check arguments
    if (typeof(_name) !==
      'string') { throw 'expected parameter `name` to be string'; }
    if (typeof(_inherit) !== 'function' &&
      _inherit !== null) { throw 'expected parameter `function` to be object'; }
    if (typeof(_tbl) !==
      'object') { throw 'expected parameter `tbl` to be object';}

    // create class
    var obj = _tbl.hasOwnProperty('constructor')
      ? _tbl.constructor
      : function() {};
